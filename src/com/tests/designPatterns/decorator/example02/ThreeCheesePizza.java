package com.tests.designPatterns.decorator.example02;
...
//Through composition I'll be able to add new functionality by writing new code rather than by changing current code.
